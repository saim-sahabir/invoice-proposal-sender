                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="full_name" class="form-control" placeholder="<?php echo lang('name'); ?>" 
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="email_address" class="form-control" placeholder="<?php echo lang('email_address'); ?>" value="<?php echo $user_details->email_address; ?>">
                            </div>
                        </div>
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="phone" class="form-control integerchk" placeholder="<?php echo lang('phone'); ?>" value="<?php echo $user_details->phone; ?>">
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="designation" class="form-control" placeholder="<?php echo lang('designation'); ?>" value="<?php echo $user_details->designation; ?>">
                                </select>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group radio_button_problem">
                                ...
                                <div class="radio">
                                    <label> 
                                        <input type="radio" name="will_login" id="will_login_yes" value="Yes" <?php if($user_details->will_login=="Yes"){echo "checked";} ?>>Yes </label>
                                    <label>

                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 

                                        <input type="radio" name="will_login" id="will_login_no" value="No" <?php if($user_details->will_login=="No"){echo "checked";} ?>>No 
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="password" class="form-control" placeholder="<?php echo lang('password'); ?>" value="<?php echo $user_details->password; ?>">
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="confirm_password" class="form-control" placeholder="<?php echo lang('confirm_password'); ?>" value="<?php echo $user_details->password; ?>">
                                </div>
