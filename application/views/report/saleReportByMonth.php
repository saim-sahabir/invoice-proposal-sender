    ...
    <div class="row"> 
        <div class="col-md-2">
            ...
            <div class="form-group"> 
                <input type="text" id="" name="startMonth" readonly class="form-control datepicker_months" placeholder="Start Month" value="<?php echo set_value('startMonth'); ?>">
            </div> 
        </div>
        <div class="col-md-2">

            <div class="form-group">
                <input type="text" id="endMonth" name="endMonth" readonly class="form-control datepicker_months" placeholder="End Month" value="<?php echo set_value('endMonth'); ?>">
            </div>
        </div>
        <div class="col-md-2">
        ...
        <div class="col-md-offset-3 col-md-2">
            <div class="form-group">
                <a target="_blank" href="<?= base_url() . 'PdfGenerator/saleReportByMonth/' ?><?= isset($start_date) ? $this->custom->encrypt_decrypt($start_date, 'encrypt') : '0'; ?>/<?= isset($end_date) ? $this->custom->encrypt_decrypt($end_date, 'encrypt') : '0'; ?>/<?= isset($user_id) ? $this->custom->encrypt_decrypt($user_id, 'encrypt') : '0'; ?>" class="btn btn-block c-btn pull-left">Export PDF</a>
            </div>
        </div> 
    </div> 
</section> 
