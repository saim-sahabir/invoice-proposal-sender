    ...
    <div class="row">
        <div class="col-md-2">
            ...
            <div class="form-group"> 
                <input type="text" id="date" name="date" readonly class="form-control" placeholder="Date" value="<?php echo set_value('date'); ?>">
            </div> 
        </div>
        <div class="col-md-1">
            <div class="form-group">
        ...
        <div class="col-md-offset-8 col-md-1">
            <div class="form-group"> 
                <a class="btn btn-block c-btn pull-left" href="<?php echo base_url(); ?>Report/printDailyConsumptionReport/<?php echo $selectedDate; ?>">Print</a>
            </div>
        </div>
    </div> 
</section> 
