...
<section class="content-header">
    <h3  style="text-align: center;margin-top: 0px">Proposal Report</h3>
    <hr style="border: 1px solid #3c8dbc;">
    <div class="row">
        <div class="col-md-2">
            <?php echo form_open(base_url() . 'Report/proposalReport') ?>
        ...
        <div class="col-md-2">
            ...
            <div class="form-group">
                <select class="form-control select2" id="status" name="expense_item_id" style="width: 100%;">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body table-responsive">
                    ...
                    if (isset($expense_item_id) && $expense_item_id):
                        echo lang('proposal_item').": <span style='text-decoration: underline'>" . userName($expense_item_id) . "</span>";
                    else:
                        echo "Proposal Item : ".lang('all');
                    endif;
                    ?></h4>
                    <br>
                    <table id="datatable"  class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo lang('proposal_no'); ?></th>
                        ...
                        <tbody>
                            ...
                            $grandTotal = 0;
                            $countTotal = 0;
                            if (isset($proposalReport)):
                                foreach ($proposalReport as $key => $value) {
...
<script>  
    ...
    var TITLE = "Proposal Report "+today; 
