    ...
    <div class="row">
        <div class="col-md-2">
            ...
            <div class="form-group">
                <input type="text" id="" name="startDate" readonly class="form-control customDatepicker" placeholder="Start Date" value="<?php echo set_value('startDate'); ?>">
            </div>
        </div>
        <div class="col-md-2">

            <div class="form-group">
                <input type="text" id="endMonth" name="endDate" readonly class="form-control customDatepicker" placeholder="End Date" value="<?php echo set_value('endDate'); ?>">
            </div>
        </div>
        <div class="col-md-3">

            <div class="form-group">
                <select class="form-control select2" id="ingredients_id" name="ingredients_id" style="width: 100%;">
        ...
        <div class="col-md-1">
            <div class="form-group">
                <button type="submit" name="submit" value="submit" class="btn btn-block c-btn pull-left">Submit</button>
            </div>
        </div>
        <div class="hidden-lg">
        ...
        <div class="col-md-offset-2 col-md-2">
            <div class="form-group">
                <a target="_blank" href="<?= base_url() . 'PdfGenerator/purchaseReportByIngredient/' ?><?= isset($start_date) && $start_date ? $this->custom->encrypt_decrypt($start_date, 'encrypt') : '0'; ?>/<?= isset($end_date) && $end_date ? $this->custom->encrypt_decrypt($end_date, 'encrypt') : '0'; ?>/<?= isset($ingredients_id) && $ingredients_id ? $this->custom->encrypt_decrypt($ingredients_id, 'encrypt') : '0'; ?>" class="btn btn-block c-btn pull-left">Export PDF</a>
            </div>
        </div>
    </div>
</section>
