...
<html lang="en">
    ...
    <body>
        <div id="main">
            <div class="section head-section standard" style="background-color:#8000FF;">
                ...
                <table class="table" cellspacing="0" cellpadding="0" border="0" style="width:100%;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="background-color:#8000FF;color:#fff;border-right:none;border-bottom:none;"> <b>Total:</b></td>
                            <td style="border-right: 1px solid #fff;background-color:#8000FF;color:#fff; border-bottom:none;"><?php echo $compnay_info->currency; ?> <?php echo $proposal_info->total; ?></td>
                        </tr>
                    </tbody>
                </table>
