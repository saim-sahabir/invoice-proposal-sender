                    ...
                    <div class="row">
                        <div class="col-md-4"> 
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control" placeholder="Name/Company Name" value="<?php echo set_value('name'); ?>">
                            </div>
                        ...
                        <div class="col-md-4"> 
                            <div class="form-group">
                                ...
                                <input type="text" name="c_person" class="form-control" placeholder="Contact Person" value="<?php echo set_value('c_person'); ?>">
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="email" class="form-control" placeholder="<?php echo lang('email'); ?>" value="<?php echo set_value('email'); ?>">
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <textarea type="text" rows="2" name="billing_address" class="form-control" placeholder="Billing Address" style="border-radius: 5px;"></textarea> 
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" rows="2" name="address" placeholder="Service Address"style="border-radius: 5px;"><?php echo $this->input->post('address'); ?></textarea>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="gst_number" class="form-control" placeholder="<?php echo lang('gst_number'); ?>" value="<?php echo set_value('gst_number'); ?>">
                            </div>
