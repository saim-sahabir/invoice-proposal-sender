        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary"> 
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" name="userfile" class="form-control" placeholder="<?php echo lang('upload_file'); ?>" value="<?php echo set_value('name'); ?>">
                            </div>
                ...
                <div class="box-footer">
                    ...
                    <a href="<?php echo base_url() ?>Master/customers"><button type="button" class="btn c-btn"><?php echo lang('back'); ?></button></a>
                    <a class="btn c-btn" href="<?php echo base_url() ?>Master/downloadPDF/Customer_Upload.xlsx">
