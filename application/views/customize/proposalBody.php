    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <?php echo form_open(base_url('Customize/proposalBody/')); ?>
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Proposal Body Content <span class="required_star">*</span></label>
                                <textarea class="textarea" name="proposal_body" style="width: 100%; height: 400px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" placeholder="<?php echo lang('enter'); ?> ..."><?php echo $customize_information->proposal_body; ?></textarea>
                            </div>
                            <?php if (form_error('proposal_body')) { ?>
                                <div class="alert alert-error" style="padding: 5px !important;">
                                    <p><?php echo form_error('proposal_body'); ?></p>
                                </div>
                            <?php } ?>
                        </div>  
                    </div>  
                ...
                <div class="box-footer">
                    ...
                    <!-- <a href="<?php echo base_url() ?>Customize/proposalBody"><button type="button" class="btn c-btn"><?php echo lang('back'); ?></button></a> -->
                </div>
                <?php echo form_close(); ?>
            </div>
        </div>
