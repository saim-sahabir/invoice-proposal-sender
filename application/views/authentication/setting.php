                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="date_format" id="date_format" style="width: 100%;">
                        ...
                        <div class="col-md-4"> 
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="currency" class="form-control" placeholder="<?php echo lang('currency'); ?>" value="<?php echo $setting_information->currency; ?>">
                            </div>
