                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="full_name" class="form-control" placeholder="<?php echo lang('name'); ?>" value="<?= isset($profile_info) && $profile_info->full_name ? $profile_info->full_name : set_value('full_name') ?>">
                            </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="email_address" class="form-control" placeholder="<?php echo lang('email_address'); ?>" value="<?= isset($profile_info) && $profile_info->email_address ? $profile_info->email_address : set_value('email_address') ?>">
                            </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="phone" class="form-control integerchk" placeholder="<?php echo lang('phone'); ?>" value="<?= isset($profile_info) && $profile_info->phone ? $profile_info->phone : set_value('phone') ?>">
                            </div>
