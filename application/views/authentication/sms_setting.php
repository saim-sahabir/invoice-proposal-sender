        ...
        <div class="col-md-12">
            <div class="box box-primary">
                    ...
                    <div class="row">
                        <div class="col-md-4"> 
                            <div class="form-group">
                                ...
                                <input type="text" name="email_address" class="form-control" placeholder="<?php echo lang('email_address'); ?>" value="<?php echo $sms_information->email_address; ?>">
                            </div>
                        ...
                        <div class="col-md-4"> 
                            <div class="form-group">
                                ...
                                <input type="text" name="password" class="form-control" placeholder="<?php echo lang('password'); ?>" value="<?php echo $sms_information->password; ?>">
                            </div>
                ...
                <div class="box-footer">
                    ...
                    <a class="btn c-btn" href="<?php echo base_url();?>Short_message_service/smsService"><?php echo lang('go_to_send_sms_page'); ?></a>
                </div>
                <?php echo form_close(); ?>
            </div>
        </div>
