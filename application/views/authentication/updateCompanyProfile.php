        ...
        <div class="col-md-12">
            <div class="box box-primary"> 
                ...
                <div class="box-footer">
                    <!-- <button type="submit" name="submit" value="submit" class="btn c-btn">Submit</button> -->
                    <a href="<?php echo base_url() ?>Outlet/outlets"><button type="button" class="btn c-btn">Back to Outlet List</button></a>
                </div>
                <?php echo form_close(); ?>
            </div>
        </div>
